...
function selectionChanged() {
	...
	// Your code goes here
	let won = selectedHero.battle(selectedVillain);
	if(won) {
		document.getElementById("winner").innerHTML = "Winner: " + selectedHeroValue + "!";
	} else {
		document.getElementById("winner").innerHTML = "Winner: " + selectedVillainValue + "!";
	}
}
